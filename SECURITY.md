...
This service stores historical games, turns, position evaluations, and provides the game ingestion API. If you discover a vulnerability (e.g. token leakage, ingest authorization bypass, SQL injection, denial of service), please report it privately.
