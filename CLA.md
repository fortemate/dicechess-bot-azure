...
maintained by Fortemate ("the Project Owner", [github.com/fortemate](https://github.com/fortemate)).
...
*Plain-language note (not a limitation of the grant above): this repository is proprietary to Fortemate. Contributions are granted to Fortemate under the terms above.*
